// imagem/semanas/22-09/ilust/ilust-universal.js
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    cssLink.href = "imagem/semanas/22-09/ilust/styles.css";
    ...
    placeholders.forEach(placeholder => {
        ...
        const htmlPath = `imagem/semanas/22-09/ilust/ilust${numero}/ilust${numero}.html`;
